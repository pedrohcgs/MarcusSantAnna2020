...
#'
#' @description \code{unc_att_gt_panel_het} computes the difference of average treatment effects across two subpopulations
...
#' @export
#'
unc_att_gt_panel_het <- function(y_name,
                                 t_name,
                                 id_name,
                                 first_treat_name,
                                 het_name,
  ...
  if(comparison_group == "notyettreated_all"){
    results_het1 <- compute_unc_att_gt_panel_ny_all_het(dp, het_val = 1)
    results_het0 <- compute_unc_att_gt_panel_ny_all_het(dp, het_val = 0)
  } else {
    results_het1 <- compute_unc_att_gt_panel_het(dp, het_val = 1)
    results_het0 <- compute_unc_att_gt_panel_het(dp, het_val = 0)
  }
  #-----------------------------------------------------------------------------
